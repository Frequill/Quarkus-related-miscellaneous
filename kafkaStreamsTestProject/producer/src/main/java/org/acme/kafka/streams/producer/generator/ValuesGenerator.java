...
public class ValuesGenerator {
    ...
    @Outgoing("temperature-values") // Instruct Reactive Messaging to dispatch the items from the returned Multi to temperature-values.
    public Multi<Record<Integer, String>> generate() {

        // The method returns a Mutiny stream (Multi) emitting a random temperature value every 0.5 seconds.
    ...
    // Instruct Reactive Messaging to dispatch the items from the returned Multi (static list of weather stations) to weather-stations.
